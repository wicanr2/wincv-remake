...
// DefaultPalette 是 29 個具名顏色的 RGB。
//
// **顏色的名字與順序已查證**(WINCV.IMG 0x5692d 的斜線分隔清單);
// **RGB 值還沒查證**。試過兩條路都不通:
//   - image 裡沒有靜態的 COLORREF 表(顏色是執行期用 NEW-COLOR 建的)
//   - 從 Wine 截圖取樣不可靠(Wine 的字型渲染帶 subpixel 色邊,
//     而且語法上色預設是關的)
// 下一步是在 IDA 裡看 NEW-COLOR 的呼叫端。在那之前這裡是**暫定值**,
// 依名稱與原版截圖中出現過的色階(0x80 / 0xC0 / 0xC5 / 0xF5 / 0xFF)推的。
// 見 CLAUDE.md §9 的假設 A8。
var DefaultPalette = [cell.NumColors]color.RGBA{
	...
	{0xF5, 0xF5, 0x00, 0xFF}, // mildyellow
	...
	{0x80, 0x00, 0xC0, 0xFF}, // purple
	{0xC5, 0x80, 0xFF, 0xFF}, // ltpurple
	{0xC0, 0x80, 0x00, 0xFF}, // orange
	{0xFF, 0xA0, 0x40, 0xFF}, // ltorange
	{0xE0, 0xE0, 0x80, 0xFF}, // gooseyellow
	{0x00, 0x80, 0x80, 0xFF}, // bluegreen
	{0x00, 0x80, 0x40, 0xFF}, // inkgreen
	{0xF5, 0xF5, 0xF5, 0xFF}, // mildwhite
	{0x80, 0xFF, 0x80, 0xFF}, // mildgreen
	{0x80, 0xFF, 0xFF, 0xFF}, // mildcyan
	{0xFF, 0x80, 0xFF, 0xFF}, // mildmagenta
}
